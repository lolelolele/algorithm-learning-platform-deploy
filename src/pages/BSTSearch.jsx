...
import BSTRenderer from "../features/bst/traversal/BSTRenderer";
import { buildBST, buildBSTFromString, presetTrees, defaultValues } from "../features/bst/data/trees";
import { generateBFSSteps } from "../features/bst/search/bst/search/logic/bstSearchSteps";
...
export default function BSTSearch() {
    ...
    const steps = generateBSTSearchSteps(treeRoot, searchValue);
